...
def run():
    ...
    # resp = stub.ExtractText(pb2.GenRequest(image_url = "https://images.pexels.com/photos/6806690/pexels-photo-6806690.jpeg", prompt = "请精确提取图中的所有文本内容，包括印刷体和清晰的手写体。请忽略水印，并丢弃无意义的文本（如单个标点符号、无上下文的孤立字符）。若图中没有文本、文本无法识别或难以识别，请输出“-1”。若有文本，请直接输出提取到的文本，不要输出任何与图中文本无关的内容。"))
    # print(resp)
    ...
    resp = stub.EmbedText(pb2.TextRequest(text = "猫"))
    print(resp)
